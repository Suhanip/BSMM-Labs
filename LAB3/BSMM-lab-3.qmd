...
On average the most used ingredient in the Boston Cocktails dataset is **orange juice** according the first normalization method and its **gin** according to the second normalization method.
